...
try {
    // Consulta SQL
    $query = "SELECT pt.id, p.nombre_comun AS planta, pt.fecha_trasplante, pt.cantidad, pt.observacion, pt.perdida_t 
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="plantas_id" class="form-control" id="plantas_id" required>
                            ...
                            $query = "SELECT id, nombre_comun, cantidad FROM plantas WHERE etapa = 'pre-germinación'";
